...
Task.create(task: 'bring cups', party: nye, guest: chels)
Task.create(task: 'bring fizzy fruit', party: nye, guest: amanda)
Task.create(task: 'bring the noise', party: nye, guest: bn)
